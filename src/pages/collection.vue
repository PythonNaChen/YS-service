...
<style scoped>
    ...
    .header .header_top .yuesao_head_img {
        width: 93px;
        height: 93px;
        border-radius: 50%;
        margin: 0 auto;
    ...
    .header .header_top .yuesao_head_img img {
        width: 93px;
        height: 93px;
        border-radius: 50%;
    }

    .header .header_top .header-detail {
        text-align: center;
        padding-bottom: 10px;
        margin-top: 70px;
    }

    .header .header_top .header-detail .yuesao_name {
        color: #f2673a;
        font-size: 16px;
        padding-top: 5px;
    }

    .header .header_top .header-detail .yuesao_name span {
        color: #fff;
    ...
    .header .header_top .header-detail .yuesao_salary {
        color: #ea5905;
        font-size: 14px;
        padding-top: 5px;
    }

    .header .header_top .header-detail .yuesao_salary span {
        font-size: 12px;
        color: #000;
        font-weight: 100;
    }

    .header .header_top .header-detail .yuesao_experience {
        color: #9d9d9d;
        font-size: 12px;
        padding-top: 5px;
    }

    .header .header_top .header-detail .yuesao_experience .experience_item {
        margin-right: 5px;
    }

    .header .header_top .header-detail .watch_detail {
    ...
    .header_bottom .header_bottom_item img {
        width: 17px;
        height: 17px;
        margin-right: 2px;
    }

    .header_bottom .header_bottom_item span {
        color: #841d1d;
        font-size: 14px;
    }
    ...
    .yuesao-index .info .title img {
        width: 19px;
        height: 17px;
        margin-right: 5px;
    }

    .yuesao-index .info-detail {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
        -webkit-box-pack: justify;
    ...
    .yuesao-index .info-detail ul {
        width: 140px;
    }

    .yuesao-index .info-detail ul:last-child {
        margin-left: 25px;
    }

    .yuesao-index .info-detail, ul li {
        color: #000;
        margin-bottom: 8px;
    ...
    .yuesao-index .character .title img {
        width: 19px;
        height: 17px;
        margin-right: 5px;
    }

    .yuesao-index .character-detail {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
    ...
    .yuesao-index .character-detail ul {
        width: 150px;
    }

    .yuesao-index .character-detail ul li {
        display: -webkit-box;
        display: -ms-flexbox;
        display: flex;
        -webkit-box-align: center;
    ...
    .yuesao-index .character .character-detail ul li span {
        width: 60px;
        height: 23px;
        line-height: 23px;
        display: inline-block;
    ...
    .yuesao-index .character .character-detail ul li img {
        width: 10px;
        height: 10px;
    }

    .yuesao-index .character-detail .character-ul-right li span {
    ...
    .skills .info_detail li {
        font-size: 14px;
        font-weight: 800;
        line-height: 22px;
    }
    .skills .info_detail li img{
        width: 10px;
        height: 10px;
        vertical-align: middle;
        margin-right: 3px;
